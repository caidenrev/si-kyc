...
function EditTransactionFormSkeleton() {
    return (
...
export default function EditTransactionPage() {
  ...
  const transactionRef = useMemoFirebase(() => (firestore && id ? doc(firestore, 'transactions', id) : null), [firestore, id]);
  const { data: transaction, isLoading: transactionLoading } = useDoc(transactionRef);
  ...
  async function onSubmit(values: z.infer<typeof transactionSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: "Perubahan pada transaksi telah berhasil disimpan.",
      });
  ...
  const isLoading = transactionLoading || customersLoading;
